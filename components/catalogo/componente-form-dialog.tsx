...
import { agregarComponente, editarComponente } from "@/lib/acciones/catalogo";
  ...
  async function manejarSubmit(evento: React.FormEvent) {
    ...
    try {
      ...
      if (esEdicion && componente) {
        await editarComponente(componente.id, datos);
        toast.success("Línea actualizada");
      } else {
        await agregarComponente(itemCatalogoId, datos);
          ...
          <div className="mt-4 grid gap-4">
            ...
            {tipo === "material" ? (
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-1.5">
                  <Label htmlFor="cantidadUnitaria">Cantidad por unidad de ítem</Label>
                  <Input
                    id="cantidadUnitaria"
                    type="number"
                    step="0.0001"
                ...
                <div className="grid gap-1.5">
                  <Label htmlFor="desperdicioPct">Desperdicio (%)</Label>
                  <Input
                    id="desperdicioPct"
                    type="number"
                    step="0.01"
              ...
              <div className="grid gap-1.5">
                <Label htmlFor="rendimientoHoras">Horas por unidad de ítem</Label>
                <Input
                  id="rendimientoHoras"
                  type="number"
                  step="0.0001"
